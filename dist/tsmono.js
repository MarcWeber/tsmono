...
var utils_restartable_processes_1 = require("./utils-restartable-processes");
...
var TSMONOJSONFile = /** @class */ (function (_super) {
    ...
    TSMONOJSONFile.prototype.dirs = function (cfg) {
        var _a;
        return unique(__spreadArray(__spreadArray([], ((_a = cfg.directories) !== null && _a !== void 0 ? _a : []), true), get_path(this.json, "tsmono", "directories", ["../"]), true));
    };
...
var Repository = /** @class */ (function () {
    ...
    Repository.prototype.repositories = function (opts) {
        var dep_collection = new DependencyCollection(this.cfg, this.path, this.tsmonojson.dirs(this.cfg));
            ...
            return __generator(this, function (_z) {
                switch (_z.label) {
                    ...
                    case 3:
                        ...
                        tsconfig = {};
                        dep_collection = new DependencyCollection(cfg, this.path, this.tsmonojson.dirs(this.cfg));
                        dep_collection.dependencies_of_repository(this, true, { addLinks: false });
                        dep_collection.do();
                        dep_collection.print_warnings();
                        expected_symlinks = {};
                        ...
                        _r = 0, _s = Object.entries(expected_symlinks);
                        _z.label = 4;
                    case 4:
                        if (!(_r < _s.length)) return [3 /*break*/, 8];
                        _t = _s[_r], k = _t[0], v = _t[1];
                        del_if_exists(k);
                        fs.mkdirpSync((0, path_1.dirname)(k));
                        info("symlinking ".concat(k, " -> ").concat(v));
                        if (!tsmonojson.rsync_instead_of_symlink) return [3 /*break*/, 6];
                        return [4 /*yield*/, run('rsync', { args: ['-ra', "".concat(path.join('src/tsmono', v), "/"), "".concat(k, "/")] })
                    ...
                    case 11:
                        ...
                        if (!opts.install_npm_packages) return [3 /*break*/, 14];
                        ...
                        if (!(installed !== to_be_installed || !fs.existsSync(path.join(this.path, "node_modules")))) return [3 /*break*/, 13];
                        return [4 /*yield*/, run(cfg.npm_install_cmd[0], { args: cfg.npm_install_cmd.slice(1), cwd: this.path })];
                    case 12:
                        _z.sent();
                        _z.label = 13;
                    ...
                    case 14:
                        if (opts.symlink_node_modules_hack) {
                            for (_w = 0, _x = this.tsmonojson.dirs(this.cfg); _w < _x.length; _w++) {
                                dir = _x[_w];
                        ...
                        if (!opts.recurse) return [3 /*break*/, 18];
                        opts2 = clone(opts);
                        ...
                        _z.label = 15;
                    case 15:
                        if (!(_y < repositories_1.length)) return [3 /*break*/, 18];
                        r = repositories_1[_y];
                        if (r === undefined)
                            return [3 /*break*/, 17];
...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var hd, cache, configDefaults, json_or_empty, config_from_home_dir_path, env_config, homedir_config, args_config, config, cfg, ssh_cmd, p, ensure_is_git, update, d, dd, add_1, _i, _a, v, p_1, _b, _c, r, pwd, package_contents, _d, tsconfig_contents, _e, tsmono_contents, _f, _g, _h, k, v, _j, _k, _l, pack, version, cwd, reponame_1, rL_1, sc_1, remote_exists_1, e_1, items, _m, _o, path_, p_, repo, p_2, repositories, rL_2, sc_2, results_2, check_local_1, check_remote_1, tasks, _p, results_1, i, p_3, rL_3, basenames_to_pull, seen, ensure_repo_committed_and_clean_1, ensure_remote_location_setup_1, remote_update_1, push_to_remote_location, _q, _r, rep, force, p_4, _s, _t, r, stdout, p_5, dep_collection, seen, _u, _v, _w, k, v, r, _x, _y, r, package_json_installed, external_libarries, esbuild_external_flags, restartable, watch, _z, compile_server_1, compile_web_1, restart_1, kill_all_1, server_ts_1, o_server_1, o_web_1, recompileAndStart_1, _0, compile_server, compile_web, restart_2, kill_all_2, spawn_1, o_server_2, o_api;
    return __generator(this, function (_1) {
        switch (_1.label) {
            case 0:
                ...
                json_or_empty = function (s) {
                    if (s) {
                        try {
                            return JSON.parse(s);
                        }
                        catch (e) {
                            throw "error parsing JSON ".concat(s);
                        }
                    }
                    else
                        return {};
                ...
                env_config = json_or_empty(process.env.TSMONO_CONFIG_JSON);
                homedir_config = json_or_empty(fs.existsSync(config_from_home_dir_path) ? fs.readFileSync(config_from_home_dir_path, "utf8") : undefined);
                args_config = json_or_empty(args.config_json);
                config = Object.assign({}, configDefaults, homedir_config, args_config, env_config);
                cfg = __assign(__assign({}, cfg_api(config)), config);
                if (!(cfg.directories == undefined || Array.isArray(cfg.directories)))
                    throw "directories must be an array! Check your configs";
                console.log("configDefaults is ".concat(JSON.stringify(configDefaults, undefined, 2)));
                console.log("env_config is ".concat(JSON.stringify(env_config, undefined, 2)));
                console.log("homedir_config is ".concat(JSON.stringify(homedir_config, undefined, 2)));
                console.log("args_config is ".concat(JSON.stringify(args_config, undefined, 2)));
            ...
            case 14:
                ...
                _1.label = 15;
            case 15:
                if (!(args.main_action === "pull-with-dependencies")) return [3 /*break*/, 29];
                cwd = process.cwd();
                reponame_1 = path.basename(cwd);
                rL_1 = cfg["remote-location"];
                sc_1 = ssh_cmd(rL_1.server);
                remote_exists_1 = true;
                _1.label = 16;
            case 16:
                _1.trys.push([16, 18, , 19]);
                return [4 /*yield*/, sc_1("\n      [ -f ".concat(rL_1["repositories-path-checked-out"], "}/").concat(reponame_1, "/.git/config ]\n      "), { stdout1: true })];
            case 17:
                _1.sent();
                return [3 /*break*/, 19];
            case 18:
                e_1 = _1.sent();
                info("remote directory ".concat(rL_1["repositories-path-checked-out"], "/").concat(reponame_1, "/.git/config does not exit, cannot determine dependencies"));
                remote_exists_1 = false;
                return [3 /*break*/, 19];
            case 19: return [4 /*yield*/, (function () { return __awaiter(void 0, void 0, void 0, function () {
                    var e_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, sc_1("\n             cd ".concat(rL_1["repositories-path-checked-out"], "/").concat(reponame_1, " && tsmono list-local-dependencies\n           "))];
                            case 2: return [2 /*return*/, (_a.sent()).split("\n").filter(function (x) { return /rel-path: /.test(x); }).map(function (x) { return x.slice(11); })];
                            case 3:
                                e_2 = _a.sent();
                                console.log(chalk_1.default.red("error getting dependencies assuming empty list"));
                                console.log(e_2);
                                return [2 /*return*/, []];
            ...
            case 20:
                ...
                _m = 0, _o = (__spreadArray(["../".concat(reponame_1)], items, true));
                _1.label = 21;
            case 21:
                ...
                if ((rL_1.ignoreWhenPulling || []).includes(repo))
                    return [3 /*break*/, 28];
                if (!fs.existsSync(p_)) {
                    info("creating ".concat(p_));
                    fs.mkdirpSync(p_);
                }
                if (!remote_exists_1) return [3 /*break*/, 23];
                return [4 /*yield*/, sc_1("\n        exec 2>&1\n        set -x\n        bare=".concat(rL_1["repositories-path-bare"], "/").concat(repo, "\n        repo=").concat(rL_1["repositories-path-checked-out"], "/").concat(repo, "\n        [ -d $bare ] || {\n          mkdir -p $bare; ( cd $bare; git init --bare )\n          ( cd $repo;\n            git remote add origin ").concat(path.relative(path.join(rL_1["repositories-path-checked-out"], repo), rL_1["repositories-path-bare"]), "/").concat(repo, "\n            git push --set-upstream origin master\n          )\n        }\n        ").concat(args.care_about_remote_checkout ? "( cd $repo; git pull  )" : "", "\n        "))];
            case 22:
                _1.sent();
                _1.label = 23;
            case 23:
                if (!!fs.existsSync(path.join(p_, ".git/config"))) return [3 /*break*/, 25];
                return [4 /*yield*/, run("git", { args: ["clone", "".concat(rL_1.server, ":").concat(rL_1["repositories-path-bare"], "/").concat(repo), p_] })];
            case 24:
                _1.sent();
                _1.label = 25;
            case 25:
            ...
            case 26:
                _1.sent();
                if (!(args.update && fs.existsSync(path.join(p_, "tsmono.json")))) return [3 /*break*/, 28];
            ...
            case 28:
                ...
                return [3 /*break*/, 21];
            case 29:
                if (!(args.main_action === "is-clean")) return [3 /*break*/, 31];
                info("using local dependencies as reference");
                repositories = p.repositories({ includeThis: true });
                rL_2 = cfg["remote-location"];
                sc_2 = function () { return ssh_cmd(rL_2.server); };
                results_2 = [];
                            ...
                            case 0:
                                is_clean = function () { return __awaiter(void 0, void 0, void 0, function () { var _a; return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            _a = "";
                                            return [4 /*yield*/, sc_2()("cd ".concat(rL_2["repositories-path-bare"], "/").concat(r.basename, "; git diff"))];
                                        case 1: return [2 /*return*/, (_a === (_b.sent()) ? "clean" : "dirty")];
                                    }
                                }); }); };
                                return [4 /*yield*/, is_clean()];
                                ...
                                return [4 /*yield*/, o.with_user(function () { return __awaiter(void 0, void 0, void 0, function () {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    info("".concat(r.path, " is not clean, starting shell"));
                                                    return [4 /*yield*/, run("ssh", { args: [rL_2.server, "cd ".concat(rL_2["repositories-path-checked-out"], "/").concat(r.basename, "; exec $SHELL -i")], stdout1: true })];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
            ...
            case 30:
                _1.sent();
                info("=== results ===");
                for (_p = 0, results_1 = results_2; _p < results_1.length; _p++) {
                    i = results_1[_p];
                    info(i);
                }
                _1.label = 31;
            case 31:
                if (!(args.main_action === "push-with-dependencies")) return [3 /*break*/, 35];
                p_3 = new Repository(cfg, process.cwd(), {});
                rL_3 = cfg["remote-location"];
                basenames_to_pull = [];
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                reponame = r.basename;
                                _a = "";
                                return [4 /*yield*/, run("git", { expected_exitcodes: [0, 1], args: "config --get remote.".concat(rL_3.gitRemoteLocationName, ".url").split(" "), cwd: r.path })];
                            case 1:
                                if (!(_a === (_b.sent()))) return [3 /*break*/, 5];
                                // local side
                                return [4 /*yield*/, run("git", { args: "remote add ".concat(rL_3.gitRemoteLocationName, " ").concat(rL_3.server, ":").concat(rL_3["repositories-path-bare"], "/").concat(reponame).split(" "), cwd: r.path })
                                    // remote side
                                ];
                            case 2:
                                // local side
                                _b.sent();
                                // remote side
                                return [4 /*yield*/, run("ssh", { args: [rL_3.server], cwd: r.path, stdin: "\n          bare=".concat(rL_3["repositories-path-bare"], "/").concat(reponame, "\n          target=").concat(rL_3["repositories-path-checked-out"], "/").concat(reponame, "\n          [ -d \"$bare\" ] || mkdir -p \"$bare\"; ( cd \"$bare\"; git init --bare; )\n          ").concat(args.care_about_remote_checkout ? "[ -d \"$target\" ] || ( git clone $bare $target; cd $target; git config pull.rebase true; )" : "", "\n          ") })
                            ...
                            case 3:
                                ...
                                _b.sent();
                                // local side .git/config
                                return [4 /*yield*/, run("git", { args: "push --set-upstream ".concat(rL_3.gitRemoteLocationName, " master").split(" "), cwd: r.path })];
                            case 4:
                                // local side .git/config
                                _b.sent();
                                _b.label = 5;
                        ...
                        switch (_a.label) {
                            case 0:
                                if (!args.care_about_remote_checkout)
                                    return [2 /*return*/];
                                reponame = r.basename;
                                return [4 /*yield*/, run("ssh", { args: [rL_3.server],
                                        cwd: r.path, stdin: "\n          target=".concat(rL_3["repositories-path-checked-out"], "/").concat(reponame, "\n          cd $target\n          git pull\n      ") })];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                ...
                push_to_remote_location = function (r) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                _a.sent();
                                if (!rL_3.gitRemoteLocationName) return [3 /*break*/, 5];
                                info("... pushing in ".concat(r.path, " ..."));
                                return [4 /*yield*/, run("git", { args: ["push", rL_3.gitRemoteLocationName], cwd: r.path })];
                            case 4:
                                _a.sent();
                                _a.label = 5;
                            case 5: 
                ...
                _q = 0, _r = p_3.repositories({ includeThis: true });
                _1.label = 32;
            case 32:
                if (!(_q < _r.length)) return [3 /*break*/, 35];
                rep = _r[_q];
            ...
            case 34:
                ...
                return [3 /*break*/, 32];
            case 35:
                if (!(args.main_action === "commit-all")) return [3 /*break*/, 42];
                force = args.force;
                p_4 = new Repository(cfg, process.cwd(), {});
                _s = 0, _t = p_4.repositories();
                _1.label = 36;
            case 36:
                if (!(_s < _t.length)) return [3 /*break*/, 42];
                r = _t[_s];
                if (!fs.existsSync(path.join(r.path, ".git"))) return [3 /*break*/, 41];
                return [4 /*yield*/, run("git", { args: ["diff"], cwd: r.path })];
            case 37:
                stdout = _1.sent();
                if (!(stdout !== "")) return [3 /*break*/, 41];
                console.log(stdout);
            ...
            case 41:
                ...
                return [3 /*break*/, 36];
            case 42:
                if (!(args.main_action === "reinstall-with-dependencies")) return [3 /*break*/, 44];
                p_5 = new Repository(cfg, process.cwd(), {});
                dep_collection = new DependencyCollection(cfg, p_5.path, p_5.tsmonojson.dirs(cfg));
                dep_collection.dependencies_of_repository(p_5, true, { addLinks: false });
                dep_collection.do();
                dep_collection.print_warnings();
                seen = [] // TODO: why aret there duplicates ?
                ;
                for (_u = 0, _v = Object.entries(dep_collection.dependency_locactions); _u < _v.length; _u++) {
                    _w = _v[_u], k = _w[0], v = _w[1];
                    r = v[0].repository;
                    if (r) {
                        if (seen.includes(r.path))
                            continue;
                ...
                for (_x = 0, _y = p_5.repositories(); _x < _y.length; _x++) {
                    r = _y[_x];
            ...
            case 43:
                ...
                _1.label = 44;
            case 44:
                external_libarries = ["fsevents", "esbuild", "oracledb", "better-sqlite3", "sqlite3", "pg-native", "tedious", "mysql2"];
                esbuild_external_flags = external_libarries.map(function (x) { return "--external:".concat(x); });
                restartable = function () {
                    var r = (0, utils_restartable_processes_1.restartable_processes)();
                    var dist_dir = function (o) { return "./dist/".concat(path.basename(o.ts_file)); };
                    var compile_server = function (o) { return r.spawn("compile_".concat(path.basename(o.ts_file)), 'esbuild', __spreadArray(["--outdir=".concat(dist_dir(o)), "--bundle", "--platform=node", o.ts_file], esbuild_external_flags, true)); };
                    var compile_web = function (o) { return r.spawn("compile_".concat(path.basename(o.ts_file)), 'esbuild', ["--outdir=".concat(dist_dir(o)), "--bundle", "--sourcemap", o.ts_file]); };
                    var restart = function (o) { return r.spawn("run_".concat(path.basename(o.ts_file)), 'node', [path.join(dist_dir(o), path.basename(o.ts_file).replace(/\.ts/, '.js'))], true); };
                    return __assign({ compile_server: compile_server, compile_web: compile_web, restart: restart }, r);
                };
                watch = function (f) {
                    var timer = "wait";
                    Promise.resolve().then(function () { return __importStar(require('chokidar')); }).then(function (chokidar) {
                        chokidar.watch('.', {
                            ...
                            .on('ready', function () { timer = undefined; console.log(chalk_1.default.green("chokidar setup")); })
                            .on('all', function () {
                            var args = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
                                args[_i] = arguments[_i];
                ...
                if (args.main_action == "esbuild-server-client-dev") {
                    _z = restartable(), compile_server_1 = _z.compile_server, compile_web_1 = _z.compile_web, restart_1 = _z.restart, kill_all_1 = _z.kill_all;
                    process.on('exit', function () { return kill_all_1(); });
                    server_ts_1 = args.server_ts_file;
                    o_server_1 = { ts_file: server_ts_1 };
                    o_web_1 = { ts_file: args.web_ts_file };
                    recompileAndStart_1 = function () {
                        compile_web_1(o_web_1).catch(function (e) { });
                        if (server_ts_1)
                            compile_server_1(o_server_1).then(function () { return restart_1(o_server_1); }).catch(function (e) { });
                    };
                    watch(function () { return recompileAndStart_1(); });
                    recompileAndStart_1();
                }
                if (args.main_action == "vite-server-and-api") {
                    _0 = restartable(), compile_server = _0.compile_server, compile_web = _0.compile_web, restart_2 = _0.restart, kill_all_2 = _0.kill_all, spawn_1 = _0.spawn;
                    process.on('exit', function () { return kill_all_2(); });
                    o_server_2 = { ts_file: args.server_ts_file };
                    o_api = { ts_file: args.api_ts_file };
                    compile_server(o_server_2).then(function () { return restart_2(o_server_2); }).catch(function (e) { });
